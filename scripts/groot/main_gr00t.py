...
def main(args: Args):
    ...
    env = RobotEnv(action_space=args.action_space, gripper_action_space=args.gripper_action_space)
    print(f"Created the droid env!, {args.action_space}, {args.gripper_action_space}")
